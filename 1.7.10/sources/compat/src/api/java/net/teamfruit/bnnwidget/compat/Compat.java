...
public class Compat {
	public static class CompatSound {
		...
		public static CompatSound createClickSound() {
			return new CompatSound(PositionedSoundRecord.func_147674_a(new ResourceLocation("gui.button.press"), 1.0F));
		}
	...
	public static class CompatGuiTextField extends GuiTextField {
		public CompatGuiTextField() {
			super(CompatMinecraft.getMinecraft().getFontRenderer().getFontRendererObj(), 0, 0, 0, 0);
		}

		public int getNthWordFromPosWSCompat(final int p_146197_1_, final int p_146197_2_, final boolean p_146197_3_) {
