...
public class MinecraftFontRenderer extends CompatFontRenderer {
	...
	public MinecraftFontRenderer(final WFont font, final int fontheight) {
		super(WRenderer.mc.gameSettings, null, null, true);
		this.font = font;
	...
	@Override
	public int drawStringWithShadowCompat(@Nullable final String str, final float x, final float y, final int color) {
		return drawStringCompat(str, x, y, color, true);
	}
	...
	@Override
	public int drawStringCompat(@Nullable final String str, final float x, final float y, final int color, final boolean shadow) {
		if (str!=null) {
	...
	@Override
	public int getWordWrappedHeightCompat(final String str, final int maxLength) {
